...
public class ImageController {
    ...
    public ImageController(R2StorageService r2StorageService, UserService userService) {
        this.r2StorageService = r2StorageService;
        this.userService = userService;
    }

    @PostMapping("/upload-image")
    public ResponseEntity<?> uploadImage(@AuthenticationPrincipal Jwt jwt,
        ...
        try {
            return ResponseEntity.ok(Map.of("url", r2StorageService.upload(file)));
