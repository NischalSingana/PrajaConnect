...
export function LoginPage() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-6 relative overflow-hidden bg-black min-h-screen">
      ...
      <Link to="/" className="absolute top-10 left-10 hidden md:flex items-center gap-2 text-zinc-500 hover:text-white transition-colors group px-4 py-2 rounded-lg bg-white/5 border border-white/10 text-sm font-medium z-50">
